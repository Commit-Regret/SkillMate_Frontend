    ...
    >
      ...
      <div className="flex justify-between items-center mb-4 px-6 py-3 rounded shadow-lg">
        ...
        <div className="flex gap-4 items-center">
          <button className="bg-black text-white px-3 py-1 rounded-full flex items-center gap-2">
            <FaHome /> HOME
          </button>
          <div className="w-12 h-12 flex items-center justify-center rounded-full border-2 border-black bg-black">
            <FaUser className="text-white text-2xl" />
          </div>
          <div className="w-12 h-12 flex items-center justify-center rounded-full border-2 border-black bg-black">
            <FaSignOutAlt className="text-white text-2xl cursor-pointer" title="Logout" />
          </div>
        </div>
      </div>
