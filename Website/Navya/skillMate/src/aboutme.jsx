...
import photo from "./photo.jpg"; // Replace with actual image import
import "./aboutme.css";
import messageIcon from "./Message-circle.png"; // [2]
import closeIcon from "./X-circle.png"; // [3]
...
const profiles = [
  {
    ...
    tech: ["Python", "Python", "Python", "Python", "Python", "Python", "Python", "Python", "Python", "Python"],
    image: photo,
  },
  {
    name: "Rahul Bhargav",
  ...
  return (
    <div className="detail-root">
      ...
      <div className="topbar-icons">
        <img src={messageIcon} alt="message" className="icon-btn" onClick={() => alert("Chatbox coming soon!")} />
        <img src={closeIcon} alt="close" className="icon-btn" onClick={() => navigate("/")} />
      </div>
